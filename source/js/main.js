...
//placeholder
setTimeout( function() {
  $( '.b-header, h1, #gallery, #planText, #buildings, .b-heading, #detail, #plan, #prices, #visual, #actions, #actionsDetail, #news, #newsDetail, #bigGallery, #docs, #hypothec' ).addClass( 'i-ph-animated' );
}, 500 );
